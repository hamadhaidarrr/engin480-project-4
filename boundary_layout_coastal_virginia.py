...
### USA
    ...
    'coastal_virginia':                           'coastal_virginia.geojson' 
}
...
def plot_bound(farm_names):
    ...
    for i in farm_names:
        ...
        with open('boundary_layouts_ENGIN480/utm_boundary3C.pkl', 'wb') as f:
    ...
    for j in range(len(list_wind_farms_europe)):
        ...
        with open('boundary_layouts_ENGIN480/utm_layout3C.pkl', 'wb') as f:
